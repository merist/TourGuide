...
public class PlaceAdapter  extends ArrayAdapter<Place> {
     ...
     * @param placeList   A List of Place objects to display in a list
     */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // Find the TextView in the place_item.xml layout with the ID place_name
        ...
        // Find the TextView in the place_item.xml layout with the ID place_address
        ...
        // Find the ImageView in the place_item.xml layout with the ID list_item_icon
        ImageView iconView = (ImageView) listItemView.findViewById(R.id.list_item_icon);
        // Get the image resource ID from the current Place object and
        // set the image to iconView
        iconView.setImageResource(Integer.valueOf(currentPlace.getImageResourceId()));
